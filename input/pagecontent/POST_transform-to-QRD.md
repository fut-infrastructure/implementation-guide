  ...
  "parameter": [
    {
      ...
      "resource": {
        ...
        "entry": [
          {
            "fullUrl": "https://questionnaire.cit-document-transformation-1493.local/fhir/Questionnaire/40107",
            "resource": {
                  ...
                  "extension": [
                    {
                      "url": "reference",
                      "valueReference": {
                        "reference": "https://organization.cit-document-transformation-1493.local/fhir/Organization/88420"
                      }
                    },
                    {
                      "url": "role",
              ...
              "version": "1.0",
              "name": "b98f39f8-84b3-4ee4-8769-2949ab9ca5bb",
              "status": "active",
              "item": [
                {
                  "linkId": "f84b2c38-1bb4-4d7c-b152-3c80188eeb8a,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "text"
                },
                {
                  "extension": [
                    {
                      ...
                      "valueDateTime": "2023-08-24T21:44:06+00:00"
                    },
                    {
                  ...
                  "linkId": "df691620-fb77-4631-8e6c-e99343f48ee6,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "dateTime",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "f2a27aac-2ead-4d9e-9563-965a2155f930,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "decimal",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "0a97bd11-a950-42d6-ba2c-78c5e6e5837c,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "decimal",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "71b85d2a-f17a-4aad-9df3-f283a489b178,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "choice",
                  "required": true,
                  "repeats": true,
                  "answerOption": [
                ...
                },
                {
                  ...
                  "linkId": "70320ee2-d85c-4c1a-b83c-954bde4f06d4,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "choice",
                  "required": true,
                  "repeats": true,
                  "answerOption": [
          ...
          {
            "fullUrl": "https://measurement.cit-document-transformation-1493.local/fhir/QuestionnaireResponse/85026",
            "resource": {
              ...
              "extension": [
                {
                  ...
                  "valueReference": {
                    "reference": "https://careplan.cit-document-transformation-1493.local/fhir/EpisodeOfCare/7000"
                  }
                },
                {
              ...
              "basedOn": [
                {
                  "reference": "https://careplan.cit-document-transformation-1493.local/fhir/ServiceRequest/35955"
                }
              ],
              "questionnaire": "https://questionnaire.cit-document-transformation-1493.local/fhir/Questionnaire/40107",
              "status": "completed",
              "subject": {
                "reference": "https://patient.cit-document-transformation-1493.local/fhir/Patient/99764"
              },
              "authored": "2023-08-24T21:44:06+00:00",
              "source": {
                "reference": "https://patient.cit-document-transformation-1493.local/fhir/Patient/31588"
              },
              "item": [
                {
                  "linkId": "f84b2c38-1bb4-4d7c-b152-3c80188eeb8a,1.2.208.176.1.5,Sundhedsdatastyrelsen",
          ...
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1493.local/fhir/Composition/44388",
            "resource": {
              ...
              "extension": [
                {
                  ...
                  "valueReference": {
                    "reference": "https://organization.cit-document-transformation-1493.local/fhir/Organization/41852"
                  }
                }
              ],
              "identifier": {
              ...
              "subject": {
                "reference": "https://patient.cit-document-transformation-1493.local/fhir/Patient/78182"
              },
              "date": "2023-08-24T21:44:06+00:00",
              "author": [
                {
                  "reference": "https://patient.cit-document-transformation-1493.local/fhir/Patient/78182"
                }
              ...
              "confidentiality": "N",
              "custodian": {
                "reference": "https://organization.cit-document-transformation-1493.local/fhir/Organization/80434"
              },
              "relatesTo": [
                {
                  "code": "appends",
                  "targetReference": {
                    "reference": "https://document-transformation.cit-document-transformation-1493.local/fhir/Composition/50852"
                  }
                }
              ],
              "section": [
                {
                  "entry": [
                    {
                      "reference": "https://questionnaire.cit-document-transformation-1493.local/fhir/Questionnaire/40107"
                    },
                    {
                      "reference": "https://measurement.cit-document-transformation-1493.local/fhir/QuestionnaireResponse/85026"
                    },
                    {
                      "reference": "https://document-transformation.cit-document-transformation-1493.local/fhir/DocumentReference/89668"
                    },
                    {
                      "reference": "https://document-transformation.cit-document-transformation-1493.local/fhir/Composition/50852"
                    }
          ...
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1493.local/fhir/Composition/50852",
            "resource": {
              "resourceType": "Composition",
              "id": "50852",
              "meta": {
              ...
              "contained": [
                {
                  ...
                  "managingOrganization": {
                    "reference": "https://organization.cit-document-transformation-1493.local/fhir/Organization/64301"
                  }
                },
                {
                  ...
                  "name": [
                    {
                      "family": "3fe4b432-f914-4e69-be52-5e6ad8f3db42"
                    }
                  ]
                }
              ],
              ...
              "title": "e3aaa4df-d096-415d-938c-19c454686699"
            }
          },
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1493.local/fhir/DocumentReference/89668",
            "resource": {
              ...
              "date": "2023-08-24T21:44:06.598+00:00",
              "content": [
                {
                  "attachment": {
                    "url": "http://some.com/"
          ...
          {
            "fullUrl": "https://patient.cit-document-transformation-1493.local/fhir/Patient/78182",
            "resource": {
              "resourceType": "Patient",
              "id": "78182",
              "meta": {
              ...
              "managingOrganization": {
                "reference": "https://organization.cit-document-transformation-1493.local/fhir/Organization/84541"
              }
            }
          },
          {
            "fullUrl": "https://organization.cit-document-transformation-1493.local/fhir/Organization/80434",
            "resource": {
              ...
              "identifier": [
                {
                  ...
                  "value": "11111111",
                  "period": {
                    "start": "2023-08-24T21:44:06+00:00"
                  }
                },
                {
          ...
          {
            "fullUrl": "https://organization.cit-document-transformation-1493.local/fhir/Organization/41852",
            "resource": {
              "resourceType": "Organization",
              "id": "41852",
              "meta": {
