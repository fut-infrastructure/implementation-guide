...
```json
{
  ...
  "identifier": [
    {
      ...
      "value": "23101297-1793-4aee-bfc8-be5d66e7add3"
    },
    {
      "system": "http://ehealth.sundhed.dk/id/ehealth-identifier",
      "value": "e5521e34-06ef-4220-a63d-facf4b2d6036_NPU03011"
    },
    {
      "system": "http://ehealth.sundhed.dk/id/ehealth-identifier",
      "value": "5eafdc04-6ef0-4d46-a833-0fe985e7fb6b_MCS88015"
    }
  ],
  "basedOn": [
    {
  ...
  "code": {
    ...
    "text": "575af32e-bbd4-4184-94bf-db9e9f7d2fb4"
  },
  "subject": {
    "reference": "https://patient.cit-measurement-1673.local/fhir/Patient/34552"
  },
  "effectivePeriod": {
    "start": "2023-10-16T08:46:21+00:00",
    "end": "2023-10-16T08:46:21+00:00"
  },
  "performer": [
    {
      "reference": "https://patient.cit-measurement-1673.local/fhir/Patient/83104"
    }
  ],
  "device": {
    "reference": "https://device.cit-measurement-1673.local/fhir/Device/86957"
  },
  "component": [
    {
      "code": {
