...
### ConditionId
The `item.enableWhenBehaviour.conditionId` can be used to identify conditions. This property is primarily used when modeling Questionnaire which should be transformed to CDA documents.