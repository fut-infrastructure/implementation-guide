  ...
  "parameter": [
    {
      ...
      "resource": {
        ...
        "entry": [
          {
            "fullUrl": "https://questionnaire.cit-document-transformation-1341.local/fhir/Questionnaire/15330",
            "resource": {
                  ...
                  "extension": [
                    {
                      "url": "reference",
                      "valueReference": {
                        "reference": "https://organization.cit-document-transformation-1341.local/fhir/Organization/59985"
                      }
                    },
                    {
                      "url": "role",
              ...
              "version": "1.0",
              "name": "76e7a171-687b-4839-b562-7e2e2161031e",
              "status": "active",
              "item": [
                {
                  "linkId": "ced92c95-c0b2-4b86-b9c1-c8723940f716,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "text"
                },
                {
                  "extension": [
                    {
                      ...
                      "valueDateTime": "2022-09-16T10:17:23+00:00"
                    },
                    {
                  ...
                  "linkId": "557fcbb2-d43b-42fb-a1bd-1bb6534ee02c,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "dateTime",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "29d85541-1409-4c7c-adf0-f857a3621a7c,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "decimal",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "1da3c96b-9388-4c45-8b8a-65217ccca078,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "decimal",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "57bb1c53-ea31-4552-b9ba-7ec6a906ebcd,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "choice",
                  "required": true,
                  "repeats": true,
                  "answerOption": [
                ...
                },
                {
                  ...
                  "linkId": "020ff07b-e74a-4043-88ab-ea40e8408b0c,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "choice",
                  "required": true,
                  "repeats": true,
                  "answerOption": [
          ...
          {
            "fullUrl": "https://measurement.cit-document-transformation-1341.local/fhir/QuestionnaireResponse/33267",
            "resource": {
              ...
              "extension": [
                {
                  ...
                  "valueReference": {
                    "reference": "https://careplan.cit-document-transformation-1341.local/fhir/EpisodeOfCare/80886"
                  }
                },
                {
              ...
              "basedOn": [
                {
                  "reference": "https://careplan.cit-document-transformation-1341.local/fhir/ServiceRequest/18190"
                }
              ],
              "questionnaire": "https://questionnaire.cit-document-transformation-1341.local/fhir/Questionnaire/15330",
              "status": "completed",
              "subject": {
                "reference": "https://patient.cit-document-transformation-1341.local/fhir/Patient/72838"
              },
              "authored": "2022-09-16T10:17:23+00:00",
              "source": {
                "reference": "https://patient.cit-document-transformation-1341.local/fhir/Patient/43057"
              },
              "item": [
                {
                  "linkId": "ced92c95-c0b2-4b86-b9c1-c8723940f716,1.2.208.176.1.5,Sundhedsdatastyrelsen",
          ...
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1341.local/fhir/Composition/82323",
            "resource": {
              ...
              "extension": [
                {
                  ...
                  "valueReference": {
                    "reference": "https://organization.cit-document-transformation-1341.local/fhir/Organization/14242"
                  }
                }
              ],
              "identifier": {
              ...
              "subject": {
                "reference": "https://patient.cit-document-transformation-1341.local/fhir/Patient/61050"
              },
              "date": "2022-09-16T10:17:23+00:00",
              "author": [
                {
                  "reference": "https://patient.cit-document-transformation-1341.local/fhir/Patient/61050"
                }
              ...
              "confidentiality": "N",
              "custodian": {
                "reference": "https://organization.cit-document-transformation-1341.local/fhir/Organization/77468"
              },
              "relatesTo": [
                {
                  "code": "appends",
                  "targetReference": {
                    "reference": "https://document-transformation.cit-document-transformation-1341.local/fhir/Composition/56769"
                  }
                }
              ],
              "section": [
                {
                  "entry": [
                    {
                      "reference": "https://questionnaire.cit-document-transformation-1341.local/fhir/Questionnaire/15330"
                    },
                    {
                      "reference": "https://measurement.cit-document-transformation-1341.local/fhir/QuestionnaireResponse/33267"
                    },
                    {
                      "reference": "https://document-transformation.cit-document-transformation-1341.local/fhir/DocumentReference/62469"
                    },
                    {
                      "reference": "https://document-transformation.cit-document-transformation-1341.local/fhir/Composition/56769"
                    }
          ...
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1341.local/fhir/Composition/56769",
            "resource": {
              "resourceType": "Composition",
              "id": "56769",
              "meta": {
              ...
              "contained": [
                {
                  ...
                  "managingOrganization": {
                    "reference": "https://organization.cit-document-transformation-1341.local/fhir/Organization/18382"
                  }
                },
                {
                  ...
                  "name": [
                    {
                      "family": "a902a5ea-c487-4388-9369-6991dd887fb7"
                    }
                  ]
                }
              ],
              ...
              "title": "65028cdd-3ddb-42a8-9794-533eec2ecd6d"
            }
          },
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1341.local/fhir/DocumentReference/62469",
            "resource": {
              ...
              "date": "2022-09-16T10:17:23.326+00:00",
              "content": [
                {
                  "attachment": {
                    "url": "http://some.com/"
          ...
          {
            "fullUrl": "https://patient.cit-document-transformation-1341.local/fhir/Patient/61050",
            "resource": {
              "resourceType": "Patient",
              "id": "61050",
              "meta": {
              ...
              "managingOrganization": {
                "reference": "https://organization.cit-document-transformation-1341.local/fhir/Organization/90660"
              }
            }
          },
          {
            "fullUrl": "https://organization.cit-document-transformation-1341.local/fhir/Organization/77468",
            "resource": {
              ...
              "identifier": [
                {
                  ...
                  "value": "11111111",
                  "period": {
                    "start": "2022-09-16T10:17:23+00:00"
                  }
                },
                {
          ...
          {
            "fullUrl": "https://organization.cit-document-transformation-1341.local/fhir/Organization/14242",
            "resource": {
              "resourceType": "Organization",
              "id": "14242",
              "meta": {
