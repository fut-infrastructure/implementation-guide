  ...
  "parameter": [
    {
      ...
      "resource": {
        ...
        "entry": [
          {
            "fullUrl": "https://questionnaire.cit-document-transformation-1479.local/fhir/Questionnaire/57910",
            "resource": {
                  ...
                  "extension": [
                    {
                      "url": "reference",
                      "valueReference": {
                        "reference": "https://organization.cit-document-transformation-1479.local/fhir/Organization/43602"
                      }
                    },
                    {
                      "url": "role",
              ...
              "version": "1.0",
              "name": "0076e43f-6582-4db8-906b-1aeacdbf43c0",
              "status": "active",
              "item": [
                {
                  "linkId": "f26105f9-3c62-43a8-bddd-3dc1a8ab0165,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "text"
                },
                {
                  "extension": [
                    {
                      ...
                      "valueDateTime": "2023-08-16T06:33:32+00:00"
                    },
                    {
                  ...
                  "linkId": "cf95bb70-547e-4dbf-9e17-da53fda09193,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "dateTime",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "84a35d79-f4fc-4766-8dea-e9ae9ab99988,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "decimal",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "3bf283ab-c7c4-4188-a194-f4907dce5d4d,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "decimal",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "c943ec9a-b71a-458b-baeb-0520b8a0a0f1,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "choice",
                  "required": true,
                  "repeats": true,
                  "answerOption": [
                ...
                },
                {
                  ...
                  "linkId": "3c0453c9-760f-4ef6-934e-332526d81bec,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "choice",
                  "required": true,
                  "repeats": true,
                  "answerOption": [
          ...
          {
            "fullUrl": "https://measurement.cit-document-transformation-1479.local/fhir/QuestionnaireResponse/29728",
            "resource": {
              ...
              "extension": [
                {
                  ...
                  "valueReference": {
                    "reference": "https://careplan.cit-document-transformation-1479.local/fhir/EpisodeOfCare/80725"
                  }
                },
                {
              ...
              "basedOn": [
                {
                  "reference": "https://careplan.cit-document-transformation-1479.local/fhir/ServiceRequest/99267"
                }
              ],
              "questionnaire": "https://questionnaire.cit-document-transformation-1479.local/fhir/Questionnaire/57910",
              "status": "completed",
              "subject": {
                "reference": "https://patient.cit-document-transformation-1479.local/fhir/Patient/66542"
              },
              "authored": "2023-08-16T06:33:33+00:00",
              "source": {
                "reference": "https://patient.cit-document-transformation-1479.local/fhir/Patient/94760"
              },
              "item": [
                {
                  "linkId": "f26105f9-3c62-43a8-bddd-3dc1a8ab0165,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                ...
                },
                {
                  ...
                  "answer": [
                    {
                      "valueDateTime": "2023-08-16T06:33:33+00:00"
                    }
                  ]
                },
                {
          ...
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1479.local/fhir/Composition/86385",
            "resource": {
              ...
              "extension": [
                {
                  ...
                  "valueReference": {
                    "reference": "https://organization.cit-document-transformation-1479.local/fhir/Organization/86450"
                  }
                }
              ],
              "identifier": {
              ...
              "subject": {
                "reference": "https://patient.cit-document-transformation-1479.local/fhir/Patient/3531"
              },
              "date": "2023-08-16T06:33:33+00:00",
              "author": [
                {
                  "reference": "https://patient.cit-document-transformation-1479.local/fhir/Patient/3531"
                }
              ...
              "confidentiality": "N",
              "custodian": {
                "reference": "https://organization.cit-document-transformation-1479.local/fhir/Organization/66227"
              },
              "relatesTo": [
                {
                  "code": "appends",
                  "targetReference": {
                    "reference": "https://document-transformation.cit-document-transformation-1479.local/fhir/Composition/16339"
                  }
                }
              ],
              "section": [
                {
                  "entry": [
                    {
                      "reference": "https://questionnaire.cit-document-transformation-1479.local/fhir/Questionnaire/57910"
                    },
                    {
                      "reference": "https://measurement.cit-document-transformation-1479.local/fhir/QuestionnaireResponse/29728"
                    },
                    {
                      "reference": "https://document-transformation.cit-document-transformation-1479.local/fhir/DocumentReference/33167"
                    },
                    {
                      "reference": "https://document-transformation.cit-document-transformation-1479.local/fhir/Composition/16339"
                    }
          ...
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1479.local/fhir/Composition/16339",
            "resource": {
              "resourceType": "Composition",
              "id": "16339",
              "meta": {
              ...
              "contained": [
                {
                  ...
                  "managingOrganization": {
                    "reference": "https://organization.cit-document-transformation-1479.local/fhir/Organization/44596"
                  }
                },
                {
                  ...
                  "name": [
                    {
                      "family": "fddda7ab-0f50-44a5-b303-2591f2972b1d"
                    }
                  ]
                }
              ],
              ...
              "date": "2023-08-16T06:33:32+00:00",
              "author": [
                {
                  "reference": "#2"
                }
              ],
              "title": "441648ac-ef88-4eca-b96c-9ce563b016f5"
            }
          },
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1479.local/fhir/DocumentReference/33167",
            "resource": {
              ...
              "date": "2023-08-16T06:33:33.094+00:00",
              "content": [
                {
                  "attachment": {
                    "url": "http://some.com/"
          ...
          {
            "fullUrl": "https://patient.cit-document-transformation-1479.local/fhir/Patient/3531",
            "resource": {
              "resourceType": "Patient",
              "id": "3531",
              "meta": {
              ...
              "managingOrganization": {
                "reference": "https://organization.cit-document-transformation-1479.local/fhir/Organization/85374"
              }
            }
          },
          {
            "fullUrl": "https://organization.cit-document-transformation-1479.local/fhir/Organization/66227",
            "resource": {
              ...
              "identifier": [
                {
                  ...
                  "value": "11111111",
                  "period": {
                    "start": "2023-08-16T06:33:33+00:00"
                  }
                },
                {
          ...
          {
            "fullUrl": "https://organization.cit-document-transformation-1479.local/fhir/Organization/86450",
            "resource": {
              "resourceType": "Organization",
              "id": "86450",
              "meta": {
