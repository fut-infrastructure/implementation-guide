  ...
  "parameter": [
    {
      ...
      "resource": {
        ...
        "entry": [
          {
            "fullUrl": "https://questionnaire.cit-document-transformation-1352.local/fhir/Questionnaire/86434",
            "resource": {
                  ...
                  "extension": [
                    {
                      "url": "reference",
                      "valueReference": {
                        "reference": "https://organization.cit-document-transformation-1352.local/fhir/Organization/16943"
                      }
                    },
                    {
                      "url": "role",
              ...
              "version": "1.0",
              "name": "c618cfc4-d6a5-44d4-afde-8dc1927b1cde",
              "status": "active",
              "item": [
                {
                  "linkId": "28dd5521-94d2-41bc-b37d-c0e70022810b,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "text"
                },
                {
                  "extension": [
                    {
                      ...
                      "valueDateTime": "2022-10-11T10:10:10+00:00"
                    },
                    {
                  ...
                  "linkId": "4120d1fb-92c6-424d-a913-6a1a7d90a6fd,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "dateTime",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "725c9ad3-55c8-4c86-9d64-a286121b2432,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "decimal",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "ce4ee23a-5e57-408b-8ba1-52e19e8d35b3,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "decimal",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "6548ac9c-013d-48f8-9316-6e9f88d46393,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "choice",
                  "required": true,
                  "repeats": true,
                  "answerOption": [
                ...
                },
                {
                  ...
                  "linkId": "6a21d349-01e4-4c14-93c5-69eb373edc36,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "choice",
                  "required": true,
                  "repeats": true,
                  "answerOption": [
          ...
          {
            "fullUrl": "https://measurement.cit-document-transformation-1352.local/fhir/QuestionnaireResponse/26299",
            "resource": {
              ...
              "extension": [
                {
                  ...
                  "valueReference": {
                    "reference": "https://careplan.cit-document-transformation-1352.local/fhir/EpisodeOfCare/13263"
                  }
                },
                {
              ...
              "basedOn": [
                {
                  "reference": "https://careplan.cit-document-transformation-1352.local/fhir/ServiceRequest/97531"
                }
              ],
              "questionnaire": "https://questionnaire.cit-document-transformation-1352.local/fhir/Questionnaire/86434",
              "status": "completed",
              "subject": {
                "reference": "https://patient.cit-document-transformation-1352.local/fhir/Patient/48583"
              },
              "authored": "2022-10-11T10:10:10+00:00",
              "source": {
                "reference": "https://patient.cit-document-transformation-1352.local/fhir/Patient/89358"
              },
              "item": [
                {
                  "linkId": "28dd5521-94d2-41bc-b37d-c0e70022810b,1.2.208.176.1.5,Sundhedsdatastyrelsen",
          ...
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1352.local/fhir/Composition/17479",
            "resource": {
              ...
              "extension": [
                {
                  ...
                  "valueReference": {
                    "reference": "https://organization.cit-document-transformation-1352.local/fhir/Organization/23230"
                  }
                }
              ],
              "identifier": {
              ...
              "subject": {
                "reference": "https://patient.cit-document-transformation-1352.local/fhir/Patient/64487"
              },
              "date": "2022-10-11T10:10:10+00:00",
              "author": [
                {
                  "reference": "https://patient.cit-document-transformation-1352.local/fhir/Patient/64487"
                }
              ...
              "confidentiality": "N",
              "custodian": {
                "reference": "https://organization.cit-document-transformation-1352.local/fhir/Organization/58200"
              },
              "relatesTo": [
                {
                  "code": "appends",
                  "targetReference": {
                    "reference": "https://document-transformation.cit-document-transformation-1352.local/fhir/Composition/8057"
                  }
                }
              ],
              "section": [
                {
                  "entry": [
                    {
                      "reference": "https://questionnaire.cit-document-transformation-1352.local/fhir/Questionnaire/86434"
                    },
                    {
                      "reference": "https://measurement.cit-document-transformation-1352.local/fhir/QuestionnaireResponse/26299"
                    },
                    {
                      "reference": "https://document-transformation.cit-document-transformation-1352.local/fhir/DocumentReference/36988"
                    },
                    {
                      "reference": "https://document-transformation.cit-document-transformation-1352.local/fhir/Composition/8057"
                    }
          ...
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1352.local/fhir/Composition/8057",
            "resource": {
              "resourceType": "Composition",
              "id": "8057",
              "meta": {
              ...
              "contained": [
                {
                  ...
                  "managingOrganization": {
                    "reference": "https://organization.cit-document-transformation-1352.local/fhir/Organization/38870"
                  }
                },
                {
                  ...
                  "name": [
                    {
                      "family": "dcabf432-b28f-4a19-ab60-f02ceef15ab8"
                    }
                  ]
                }
              ],
              ...
              "title": "823ed4d6-37f0-40ef-827d-1c6b9fed06b2"
            }
          },
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1352.local/fhir/DocumentReference/36988",
            "resource": {
              ...
              "date": "2022-10-11T10:10:10.775+00:00",
              "content": [
                {
                  "attachment": {
                    "url": "http://some.com/"
          ...
          {
            "fullUrl": "https://patient.cit-document-transformation-1352.local/fhir/Patient/64487",
            "resource": {
              "resourceType": "Patient",
              "id": "64487",
              "meta": {
              ...
              "managingOrganization": {
                "reference": "https://organization.cit-document-transformation-1352.local/fhir/Organization/64279"
              }
            }
          },
          {
            "fullUrl": "https://organization.cit-document-transformation-1352.local/fhir/Organization/58200",
            "resource": {
              ...
              "identifier": [
                {
                  ...
                  "value": "11111111",
                  "period": {
                    "start": "2022-10-11T10:10:10+00:00"
                  }
                },
                {
          ...
          {
            "fullUrl": "https://organization.cit-document-transformation-1352.local/fhir/Organization/23230",
            "resource": {
              "resourceType": "Organization",
              "id": "23230",
              "meta": {
