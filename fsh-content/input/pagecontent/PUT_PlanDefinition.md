...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2022-06-15T15:22:54.043+00:00",
    "profile": [
  ...
  "extension": [
      ...
      "extension": [
        {
          "url": "reference",
          "valueReference": {
            "reference": "https://organization.cit-plan-1108.local/fhir/Organization/5592"
          }
        },
        {
          "url": "role",
    ...
    },
    {
      ...
      "valueIdentifier": {
        ...
        "value": "urn:uuid:a22834ce-2d0a-454a-b763-6333dd33a96a",
        "assigner": {
          "identifier": {
  ...
  "identifier": [
    {
      "system": "urn:ietf:rfc:3986",
      "value": "urn:uuid:c9b6d77f-fe1e-4100-be84-e49a90504a30"
    }
  ],
  "version": "1.0",
  "status": "active",
  "action": [
    {
      "definitionCanonical": "https://plan.cit-plan-1108.local/fhir/PlanDefinition/240"
    }
  ]
}
```
...
```json
{
  ...
  "meta": {
    "versionId": "2",
    "lastUpdated": "2022-06-15T15:22:54.289+00:00",
    "profile": [
      "http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-plandefinition"
    ]
  },
