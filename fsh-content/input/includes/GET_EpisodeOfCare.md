...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2023-05-16T07:53:21.136+00:00",
    "source": "#c9111e74-24b2-9f",
    "profile": [
  ...
  "extension": [
    {
      ...
      "valueReference": {
        "reference": "https://organization.cit-careplan-2467.local/fhir/Organization/70644"
      }
    },
    {
      ...
      "extension": [
        {
          "url": "careTeam",
          "valueReference": {
            "reference": "https://organization.cit-careplan-2467.local/fhir/CareTeam/44001"
          }
        },
        {
          "url": "period",
          "valuePeriod": {
            "start": "2023-05-16T07:53:21+00:00"
          }
        }
      ]
    }
  ...
  "diagnosis": [
    {
      "condition": {
        "reference": "https://careplan.cit-careplan-2467.local/fhir/Condition/2500"
      }
    }
  ],
  "patient": {
