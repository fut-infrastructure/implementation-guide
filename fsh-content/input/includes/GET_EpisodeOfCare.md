...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2023-01-06T09:03:17.297+00:00",
    "source": "#cd95e5c5-032d-9d",
    "profile": [
  ...
  "extension": [
    {
      ...
      "valueReference": {
        "reference": "https://organization.cit-careplan-2271.local/fhir/Organization/67481"
      }
    },
    {
      ...
      "extension": [
        {
          "url": "careTeam",
          "valueReference": {
            "reference": "https://organization.cit-careplan-2271.local/fhir/CareTeam/69766"
          }
        },
        {
          "url": "period",
          "valuePeriod": {
            "start": "2023-01-06T09:03:17+00:00"
          }
        }
      ]
    }
  ...
  "diagnosis": [
    {
      "condition": {
        "reference": "https://careplan.cit-careplan-2271.local/fhir/Condition/2280"
      }
    }
  ],
  "patient": {
