  ...
  "extension": [
    {
      ...
      "valueReference": {
        "reference": "https://careplan.cit-careplan-2135.local/fhir/EpisodeOfCare/2080"
      }
    }
  ],
  "status": "active",
  "subject": {
    "reference": "https://patient.cit-careplan-2135.local/fhir/Patient/53932"
  }
}
```
...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2022-10-10T15:04:39.622+00:00",
    "profile": [
      "http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-communication-request"
    ]
  },
