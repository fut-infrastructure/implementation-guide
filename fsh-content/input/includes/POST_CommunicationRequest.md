  ...
  "extension": [
    {
      ...
      "valueReference": {
        "reference": "https://careplan.cit-careplan-2271.local/fhir/EpisodeOfCare/1980"
      }
    }
  ],
  "status": "active",
  "subject": {
    "reference": "https://patient.cit-careplan-2271.local/fhir/Patient/4712"
  }
}
```
...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2023-01-06T09:00:59.526+00:00",
    "profile": [
      "http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-communication-request"
    ]
  },
