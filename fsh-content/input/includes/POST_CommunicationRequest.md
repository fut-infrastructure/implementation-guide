  ...
  "extension": [
    {
      ...
      "valueReference": {
        "reference": "https://careplan.cit-careplan-2097.local/fhir/EpisodeOfCare/2004"
      }
    }
  ],
  "status": "active",
  "subject": {
    "reference": "https://patient.cit-careplan-2097.local/fhir/Patient/82240"
  }
}
```
...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2022-09-16T09:18:14.629+00:00",
    "profile": [
      "http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-communication-request"
    ]
  },
