...
Expression:  "category.coding.code = 'notification' implies recipient.reference.contains('Patient/') and ( sender.reference.contains('Device/') or contained.ofType(Device).where('#' + id = %resource.sender.reference).empty().not())"
Severity:    #error

Invariant:   advice-invariant
Description: "Category advice invariant"
Expression:  "category.coding.code = 'advice' implies recipient.reference.contains('Patient/') and ( sender.reference.contains('Device/') or contained.ofType(Device).where('#' + id = %resource.sender.reference).empty().not())"
Severity:    #error
