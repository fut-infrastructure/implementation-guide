  ...
  "parameter": [
    {
      ...
      "resource": {
        ...
        "entry": [
          {
            "fullUrl": "https://questionnaire.cit-document-transformation-1257.local/fhir/Questionnaire/95613",
            "resource": {
                  ...
                  "extension": [
                    {
                      "url": "reference",
                      "valueReference": {
                        "reference": "https://organization.cit-document-transformation-1257.local/fhir/Organization/91186"
                      }
                    },
                    {
                      "url": "role",
              ...
              "version": "dac37dc7-c47c-4f4b-a3e5-ce9d7d03487e",
              "name": "2eff8257-6a71-48d6-beae-726a43e5f477",
              "status": "active",
              "item": [
                {
                  "linkId": "f21e4bbb-f7fa-4b3d-bc5e-b6345b321c19,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "text"
                },
                {
                  "extension": [
                    {
                      ...
                      "valueDateTime": "2021-12-21T14:02:27+00:00"
                    },
                    {
                  ...
                  "linkId": "a0cab16f-89fb-4cec-88fc-65c0dbe77691,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "dateTime",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "e3b1ce7b-5b42-4272-a597-1b6b6a36c3fe,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "decimal",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "dff4b7d3-c536-4e74-ab2c-fa6bcfa20b75,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "decimal",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "0002bb08-64c3-4dfe-b5df-4bfce7f0855c,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "choice",
                  "required": true,
                  "repeats": true,
                  "answerOption": [
                ...
                },
                {
                  ...
                  "linkId": "260af87a-da69-41cc-9859-28ddfc3ae99f,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "choice",
                  "required": true,
                  "repeats": true,
                  "answerOption": [
          ...
          {
            "fullUrl": "https://measurement.cit-document-transformation-1257.local/fhir/QuestionnaireResponse/6382",
            "resource": {
              ...
              "extension": [
                {
                  ...
                  "valueReference": {
                    "reference": "https://careplan.cit-document-transformation-1257.local/fhir/EpisodeOfCare/65770"
                  }
                },
                {
              ...
              "basedOn": [
                {
                  "reference": "https://careplan.cit-document-transformation-1257.local/fhir/ServiceRequest/64298"
                }
              ],
              "questionnaire": "https://questionnaire.cit-document-transformation-1257.local/fhir/Questionnaire/95613",
              "status": "completed",
              "subject": {
                "reference": "https://patient.cit-document-transformation-1257.local/fhir/Patient/4046"
              },
              "authored": "2021-12-21T14:02:27+00:00",
              "source": {
                "reference": "https://patient.cit-document-transformation-1257.local/fhir/Patient/60998"
              },
              "item": [
                {
                  "linkId": "f21e4bbb-f7fa-4b3d-bc5e-b6345b321c19,1.2.208.176.1.5,Sundhedsdatastyrelsen",
          ...
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1257.local/fhir/Composition/39220",
            "resource": {
              ...
              "extension": [
                {
                  ...
                  "valueReference": {
                    "reference": "https://organization.cit-document-transformation-1257.local/fhir/Organization/39297"
                  }
                }
              ],
              "identifier": {
              ...
              "subject": {
                "reference": "https://patient.cit-document-transformation-1257.local/fhir/Patient/51614"
              },
              "date": "2021-12-21T14:02:27+00:00",
              "author": [
                {
                  "reference": "https://patient.cit-document-transformation-1257.local/fhir/Patient/51614"
                }
              ...
              "confidentiality": "N",
              "custodian": {
                "reference": "https://organization.cit-document-transformation-1257.local/fhir/Organization/70674"
              },
              "relatesTo": [
                {
                  "code": "appends",
                  "targetReference": {
                    "reference": "https://document-transformation.cit-document-transformation-1257.local/fhir/Composition/39708"
                  }
                }
              ],
              "section": [
                {
                  "entry": [
                    {
                      "reference": "https://questionnaire.cit-document-transformation-1257.local/fhir/Questionnaire/95613"
                    },
                    {
                      "reference": "https://measurement.cit-document-transformation-1257.local/fhir/QuestionnaireResponse/6382"
                    },
                    {
                      "reference": "https://document-transformation.cit-document-transformation-1257.local/fhir/DocumentReference/86090"
                    },
                    {
                      "reference": "https://document-transformation.cit-document-transformation-1257.local/fhir/Composition/39708"
                    }
          ...
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1257.local/fhir/Composition/39708",
            "resource": {
              "resourceType": "Composition",
              "id": "39708",
              "meta": {
              ...
              "contained": [
                {
                  ...
                  "managingOrganization": {
                    "reference": "https://organization.cit-document-transformation-1257.local/fhir/Organization/10783"
                  }
                },
                {
                  ...
                  "name": [
                    {
                      "family": "1ec44697-fde0-472d-9214-b596ef8cca35"
                    }
                  ]
                }
              ],
              ...
              "title": "a6d5b455-4791-4283-854f-a7f574c63244"
            }
          },
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1257.local/fhir/DocumentReference/86090",
            "resource": {
              ...
              "date": "2021-12-21T14:02:27.676+00:00",
              "content": [
                {
                  "attachment": {
                    "url": "http://some.com/"
          ...
          {
            "fullUrl": "https://patient.cit-document-transformation-1257.local/fhir/Patient/51614",
            "resource": {
              "resourceType": "Patient",
              "id": "51614",
              "meta": {
              ...
              "managingOrganization": {
                "reference": "https://organization.cit-document-transformation-1257.local/fhir/Organization/42525"
              }
            }
          },
          {
            "fullUrl": "https://organization.cit-document-transformation-1257.local/fhir/Organization/70674",
            "resource": {
              ...
              "identifier": [
                {
                  ...
                  "value": "11111111",
                  "period": {
                    "start": "2021-12-21T14:02:27+00:00"
                  }
                },
                {
          ...
          {
            "fullUrl": "https://organization.cit-document-transformation-1257.local/fhir/Organization/39297",
            "resource": {
              "resourceType": "Organization",
              "id": "39297",
              "meta": {
