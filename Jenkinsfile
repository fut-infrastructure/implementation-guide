...
podTemplate(label: label,
  containers: [
    containerTemplate(name: 'igpublisher', image: 'registry.admin.ehealth.sundhed.dk/management/igpublisher:2022-10-18', command: 'cat', ttyEnabled: true)
  ],
  imagePullSecrets: [
      'harbor'
  ]){
  ...
  node (label) {
    ...
    if (env.BRANCH_NAME == 'trifork-release-12.4') {
