...
podTemplate(label: label,
  containers: [
    containerTemplate(name: 'igpublisher', image: 'registry.admin.ehealth.sundhed.dk/management/igpublisher:2020-08-05', command: 'cat', ttyEnabled: true)
  ],
  imagePullSecrets: [
      'harbor'
  ]){
  ...
  node (label) {
    ...
    if (env.BRANCH_NAME == 'release/2020.6.1') {
