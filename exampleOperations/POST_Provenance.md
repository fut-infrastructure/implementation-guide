  ...
  "parameter": [
    {
      ...
      "resource": {
        ...
        "target": [
          {
            "reference": "http://local.ehealth.sundhed.dk:31380/trifork-fhir-server/Patient/88407"
          }
        ],
        "recorded": "2019-05-13T11:13:00.877+02:00",
        "policy": [
          "policy"
        ],
        "agent": [
          {
            "whoReference": {
              "reference": "http://local.ehealth.sundhed.dk:31380/trifork-fhir-server/Patient/90707"
            }
          }
        ]
      }
