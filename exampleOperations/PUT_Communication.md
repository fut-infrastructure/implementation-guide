...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2019-05-13T09:12:42.749+00:00",
    "profile": [
  ...
  "subject": {
    "reference": "http://local.ehealth.sundhed.dk:31380/trifork-fhir-server/Patient/11099"
  },
  "topic": [
    {
      "reference": "http://local.ehealth.sundhed.dk:31380/trifork-fhir-server/Patient/71975"
    }
  ],
  "context": {
    "reference": "http://local.ehealth.sundhed.dk:31380/hapi-fhir-server/fhir/EpisodeOfCare/10750"
  },
  "sender": {
    "reference": "http://local.ehealth.sundhed.dk:31380/trifork-fhir-server/Patient/26146"
  }
}
```
...
```json
{
  ...
  "meta": {
    "versionId": "2",
    "lastUpdated": "2019-05-13T09:12:42.900+00:00",
    "profile": [
      "http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-communication"
    ]
  },
