`GET [base]/QuestionnaireResponse/76/_history/1`
...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2019-05-13T09:13:01.244+00:00",
    "profile": [
            ...
            "coding": [
              {
                ...
                "code": "c91fad3e-0712-4981-a2d2-888e64ab06b5"
              }
            ]
          }
        }
  ...
  "basedOn": [
    {
      "reference": "http://local.ehealth.sundhed.dk:31380/hapi-fhir-server/fhir/ProcedureRequest/65666"
    }
  ],
  "questionnaire": {
    "reference": "http://local.ehealth.sundhed.dk:31380/questionnaire/fhir/Questionnaire/45524"
  },
  "status": "completed",
  "subject": {
    "reference": "http://local.ehealth.sundhed.dk:31380/trifork-fhir-server/Patient/52700"
  },
  "context": {
    "reference": "http://local.ehealth.sundhed.dk:31380/hapi-fhir-server/fhir/EpisodeOfCare/34851"
  },
  "source": {
    "reference": "http://local.ehealth.sundhed.dk:31380/trifork-fhir-server/Patient/38225"
  },
  "item": [
    {
      "linkId": "1ed8c108-3dcd-4974-925a-dc5fc0796dfb",
      "answer": [
        {
          "valueInteger": 374
        }
