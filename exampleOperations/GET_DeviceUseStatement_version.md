`GET [base]/DeviceUseStatement/143/_history/2`
...
```json
{
  ...
  "meta": {
    "versionId": "2",
    "lastUpdated": "2019-05-13T09:28:04.821+00:00",
    "profile": [
  ...
  "status": "completed",
  "subject": {
    "reference": "http://local.ehealth.sundhed.dk:31380/trifork-fhir-server/Patient/37987"
  },
  "device": {
    "reference": "http://local.ehealth.sundhed.dk:31380/hapi-fhir-server/fhir/Device/142"
  }
}
```