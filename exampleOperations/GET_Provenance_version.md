`GET [base]/Provenance/283/_history/1`
...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2019-05-13T09:13:42.092+00:00",
    "profile": [
  ...
  "target": [
    {
      "reference": "http://local.ehealth.sundhed.dk:31380/measurement/fhir/Observation/284"
    }
  ],
  "recorded": "2019-05-13T11:13:42.068+02:00",
  "policy": [
    "policy"
  ],
  "agent": [
    {
      "whoReference": {
        "reference": "http://local.ehealth.sundhed.dk:31380/trifork-fhir-server/Patient/42176"
      }
    }
  ]
}
