...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2019-05-13T09:28:20.829+00:00",
    "profile": [
  ...
  "extension": [
    ...
    },
    {
      ...
      "valueReference": {
        "reference": "http://local.ehealth.sundhed.dk:31380/organization/fhir/Organization/77073"
      }
    }
  ],
  "status": "cancelled",
  ...
  "priority": "routine",
  "context": {
    "reference": "http://local.ehealth.sundhed.dk:31380/hapi-fhir-server/fhir/EpisodeOfCare/234"
  }
}
```
...
```json
{
  ...
  "meta": {
    "versionId": "2",
    "lastUpdated": "2019-05-13T09:28:21.000+00:00",
    "profile": [
      "http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-task"
    ]
  },
