  ...
  "parameter": [
    {
      ...
      "resource": {
        ...
        "entry": [
          {
            "fullUrl": "https://questionnaire.local.ehealth.sundhed.dk/fhir/Questionnaire/96693",
            "resource": {
                  ...
                  "extension": [
                    {
                      "url": "reference",
                      "valueReference": {
                        "reference": "https://organization.local.ehealth.sundhed.dk/fhir/Organization/88766"
                      }
                    },
                    {
                      "url": "role",
              ...
              "version": "e35af0da-eaa4-4198-8994-21c3fb253a96",
              "name": "86fd3143-ed30-4390-8930-8ff12cf85a85",
              "status": "active",
              "item": [
                {
                  "linkId": "9377f883-d3dd-4483-b031-cada8a95cc51,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "text"
                },
                {
                  "extension": [
                    {
                      ...
                      "valueDateTime": "2020-04-30T06:59:35+02:00"
                    },
                    {
                  ...
                  "linkId": "d6be150d-5707-4b2b-951f-84302ec5dda3,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "dateTime"
                },
                {
                  "extension": [
                  ...
                  "linkId": "112efc8c-6f67-4ac7-b842-69b174fbf643,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "decimal"
                },
                {
                  "extension": [
                  ...
                  "linkId": "027328f8-7229-46fa-90af-1abd94a2fba1,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "decimal"
                },
                {
                  "extension": [
                  ...
                  "linkId": "9aaa749e-927f-47ba-a1e3-70b4c3c34ae3,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "choice",
                  "option": [
                    {
                      "valueCoding": {
                ...
                },
                {
                  ...
                  "linkId": "820f611c-32eb-4154-ac80-5dc02adbcfdd,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "choice",
                  "option": [
                    {
                      "valueCoding": {
          ...
          {
            "fullUrl": "https://measurement.local.ehealth.sundhed.dk/fhir/QuestionnaireResponse/4121",
            "resource": {
              ...
              "basedOn": [
                {
                  "reference": "https://careplan.local.ehealth.sundhed.dk/fhir/ProcedureRequest/42952"
                }
              ],
              "questionnaire": {
                "reference": "https://questionnaire.local.ehealth.sundhed.dk/fhir/Questionnaire/96693"
              },
              "status": "completed",
              "subject": {
                "reference": "https://patient.local.ehealth.sundhed.dk/fhir/Patient/37698"
              },
              "context": {
                "reference": "https://careplan.local.ehealth.sundhed.dk/fhir/EpisodeOfCare/13114"
              },
              "authored": "2020-04-30T06:59:35+02:00",
              "source": {
                "reference": "https://patient.local.ehealth.sundhed.dk/fhir/Patient/23376"
              },
              "item": [
                {
                  "linkId": "9377f883-d3dd-4483-b031-cada8a95cc51,1.2.208.176.1.5,Sundhedsdatastyrelsen",
          ...
          {
            "fullUrl": "https://document-transformation.local.ehealth.sundhed.dk/fhir/Composition/23763",
            "resource": {
              ...
              "extension": [
                {
                  ...
                  "valueReference": {
                    "reference": "https://organization.local.ehealth.sundhed.dk/fhir/Organization/95023"
                  }
                }
              ],
              "identifier": {
              ...
              "subject": {
                "reference": "https://patient.local.ehealth.sundhed.dk/fhir/Patient/93137"
              },
              "date": "2020-04-30T06:59:35+02:00",
              "author": [
                {
                  "reference": "https://patient.local.ehealth.sundhed.dk/fhir/Patient/93137"
                }
              ...
              "confidentiality": "N",
              "custodian": {
                "reference": "https://organization.local.ehealth.sundhed.dk/fhir/Organization/7676"
              },
              "relatesTo": [
                {
                  "code": "appends",
                  "targetReference": {
                    "reference": "https://document-transformation.local.ehealth.sundhed.dk/fhir/Composition/3706"
                  }
                }
              ],
              "section": [
                {
                  "entry": [
                    ...
                    {
                      "reference": "https://measurement.local.ehealth.sundhed.dk/fhir/QuestionnaireResponse/4121"
                    },
                    {
                      "reference": "https://document-transformation.local.ehealth.sundhed.dk/fhir/DocumentReference/85611"
                    },
                    {
                      "reference": "https://document-transformation.local.ehealth.sundhed.dk/fhir/Composition/3706"
                    }
          ...
          {
            "fullUrl": "https://document-transformation.local.ehealth.sundhed.dk/fhir/Composition/3706",
            "resource": {
              "resourceType": "Composition",
              "id": "3706",
              "meta": {
              ...
              "contained": [
                {
                  ...
                  "managingOrganization": {
                    "reference": "https://organization.local.ehealth.sundhed.dk/fhir/Organization/53317"
                  }
                },
                {
                  ...
                  "name": [
                    {
                      "family": "44095717-7c38-4f20-8da7-478899a62535"
                    }
                  ]
                }
              ],
              ...
              "title": "80e2cec0-7d19-4d02-b230-8e581c0a4d95"
            }
          },
          {
            "fullUrl": "https://document-transformation.local.ehealth.sundhed.dk/fhir/DocumentReference/85611",
            "resource": {
              ...
              "indexed": "2020-04-30T06:59:35.278+02:00",
              "content": [
                {
                  "attachment": {
                    "url": "http://some.com/"
          ...
          {
            "fullUrl": "https://patient.local.ehealth.sundhed.dk/fhir/Patient/93137",
            "resource": {
              "resourceType": "Patient",
              "id": "93137",
              "meta": {
              ...
              "managingOrganization": {
                "reference": "https://organization.local.ehealth.sundhed.dk/fhir/Organization/4954"
              }
            }
          },
          {
            "fullUrl": "https://organization.local.ehealth.sundhed.dk/fhir/Organization/7676",
            "resource": {
          ...
          {
            "fullUrl": "https://organization.local.ehealth.sundhed.dk/fhir/Organization/95023",
            "resource": {
              "resourceType": "Organization",
              "id": "95023",
              "meta": {
