  ...
  "parameter": [
    {
      ...
      "resource": {
        ...
        "entry": [
          {
            "fullUrl": "https://questionnaire.cit-document-transformation-1083.local/fhir/Questionnaire/20232",
            "resource": {
                  ...
                  "extension": [
                    {
                      "url": "reference",
                      "valueReference": {
                        "reference": "https://organization.cit-document-transformation-1083.local/fhir/Organization/30939"
                      }
                    },
                    {
                      "url": "role",
              ...
              "version": "60cb3da3-1fb9-4417-8bf5-59060236f75b",
              "name": "03c4e91f-5936-42e3-96c3-2d32248ff690",
              "status": "active",
              "item": [
                {
                  "linkId": "91ab077a-03d3-4da8-9935-055190314f6a,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "text"
                },
                {
                  "extension": [
                    {
                      ...
                      "valueDateTime": "2021-04-19T15:11:58+00:00"
                    },
                    {
                  ...
                  "linkId": "b2557de2-be07-4403-9e0f-cdb1d8e2e26f,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "dateTime",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "8d795a42-35f1-4028-8e07-fab0417eb2e5,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "decimal",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "9e0cab46-85e3-4e37-a6e0-94021b0c308b,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "decimal",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "44df8cde-6bd4-4e25-aaca-eaa7f69e9e28,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "choice",
                  "required": true,
                  "repeats": true,
                  "option": [
                ...
                },
                {
                  ...
                  "linkId": "d765a3fa-d274-4454-953e-6b157ec311c2,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "choice",
                  "required": true,
                  "repeats": true,
                  "option": [
          ...
          {
            "fullUrl": "https://measurement.cit-document-transformation-1083.local/fhir/QuestionnaireResponse/64886",
            "resource": {
              ...
              "basedOn": [
                {
                  "reference": "https://careplan.cit-document-transformation-1083.local/fhir/ProcedureRequest/60239"
                }
              ],
              "questionnaire": {
                "reference": "https://questionnaire.cit-document-transformation-1083.local/fhir/Questionnaire/20232"
              },
              "status": "completed",
              "subject": {
                "reference": "https://patient.cit-document-transformation-1083.local/fhir/Patient/50395"
              },
              "context": {
                "reference": "https://careplan.cit-document-transformation-1083.local/fhir/EpisodeOfCare/24601"
              },
              "authored": "2021-04-19T15:11:58+00:00",
              "source": {
                "reference": "https://patient.cit-document-transformation-1083.local/fhir/Patient/66006"
              },
              "item": [
                {
                  "linkId": "91ab077a-03d3-4da8-9935-055190314f6a,1.2.208.176.1.5,Sundhedsdatastyrelsen",
          ...
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1083.local/fhir/Composition/13530",
            "resource": {
              ...
              "extension": [
                {
                  ...
                  "valueReference": {
                    "reference": "https://organization.cit-document-transformation-1083.local/fhir/Organization/3741"
                  }
                }
              ],
              "identifier": {
              ...
              "subject": {
                "reference": "https://patient.cit-document-transformation-1083.local/fhir/Patient/53425"
              },
              "date": "2021-04-19T15:11:58+00:00",
              "author": [
                {
                  "reference": "https://patient.cit-document-transformation-1083.local/fhir/Patient/53425"
                }
              ...
              "confidentiality": "N",
              "custodian": {
                "reference": "https://organization.cit-document-transformation-1083.local/fhir/Organization/93583"
              },
              "relatesTo": [
                {
                  "code": "appends",
                  "targetReference": {
                    "reference": "https://document-transformation.cit-document-transformation-1083.local/fhir/Composition/78285"
                  }
                }
              ],
              "section": [
                {
                  "entry": [
                    ...
                    {
                      "reference": "https://measurement.cit-document-transformation-1083.local/fhir/QuestionnaireResponse/64886"
                    },
                    {
                      "reference": "https://document-transformation.cit-document-transformation-1083.local/fhir/DocumentReference/63020"
                    },
                    {
                      "reference": "https://document-transformation.cit-document-transformation-1083.local/fhir/Composition/78285"
                    }
          ...
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1083.local/fhir/Composition/78285",
            "resource": {
              "resourceType": "Composition",
              "id": "78285",
              "meta": {
              ...
              "contained": [
                {
                  ...
                  "managingOrganization": {
                    "reference": "https://organization.cit-document-transformation-1083.local/fhir/Organization/74274"
                  }
                },
                {
                  ...
                  "name": [
                    {
                      "family": "ca8487c7-df5d-42fa-b617-a7d3f30bcd15"
                    }
                  ]
                }
              ],
              ...
              "title": "07b16bc9-7bbd-4138-8650-2b60564dfaef"
            }
          },
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1083.local/fhir/DocumentReference/63020",
            "resource": {
              ...
              "indexed": "2021-04-19T15:11:58.243+00:00",
              "content": [
                {
                  "attachment": {
                    "url": "http://some.com/"
          ...
          {
            "fullUrl": "https://patient.cit-document-transformation-1083.local/fhir/Patient/53425",
            "resource": {
              "resourceType": "Patient",
              "id": "53425",
              "meta": {
              ...
              "managingOrganization": {
                "reference": "https://organization.cit-document-transformation-1083.local/fhir/Organization/80914"
              }
            }
          },
          {
            "fullUrl": "https://organization.cit-document-transformation-1083.local/fhir/Organization/93583",
            "resource": {
              ...
              "identifier": [
                {
                  ...
                  "value": "11111111",
                  "period": {
                    "start": "2021-04-19T15:11:58+00:00"
                  }
                },
                {
          ...
          {
            "fullUrl": "https://organization.cit-document-transformation-1083.local/fhir/Organization/3741",
            "resource": {
              "resourceType": "Organization",
              "id": "3741",
              "meta": {
