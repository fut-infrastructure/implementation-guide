  ...
  "parameter": [
    {
      ...
      "resource": {
        ...
        "entry": [
          {
            "fullUrl": "https://questionnaire.cit-document-transformation-1155.local/fhir/Questionnaire/85179",
            "resource": {
                  ...
                  "extension": [
                    {
                      "url": "reference",
                      "valueReference": {
                        "reference": "https://organization.cit-document-transformation-1155.local/fhir/Organization/80535"
                      }
                    },
                    {
                      "url": "role",
              ...
              "version": "e5e91b42-8b9c-4445-b977-d95f1ad2571f",
              "name": "ceb46717-bccc-44da-8fb5-5d7e9e631b32",
              "status": "active",
              "item": [
                {
                  "linkId": "e20ba5b7-1e94-4e1c-8ab1-ca9c96b9aaac,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "text"
                },
                {
                  "extension": [
                    {
                      ...
                      "valueDateTime": "2021-10-14T06:06:57+00:00"
                    },
                    {
                  ...
                  "linkId": "4f94cbdb-de2f-4695-a909-970ccf989f0c,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "dateTime",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "eb53cfb9-010c-466a-9eee-4e95ca8e0bc2,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "decimal",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "092945f9-3163-4ace-821d-ec695a2b8157,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "decimal",
                  "required": true,
                  "repeats": true
                },
                {
                  ...
                  "linkId": "cd57e9aa-a4d6-4d79-a9fa-24586572bfbc,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "choice",
                  "required": true,
                  "repeats": true,
                  "option": [
                ...
                },
                {
                  ...
                  "linkId": "435b4c5c-4f93-4cbd-9919-7abcac88c170,1.2.208.176.1.5,Sundhedsdatastyrelsen",
                  "type": "choice",
                  "required": true,
                  "repeats": true,
                  "option": [
          ...
          {
            "fullUrl": "https://measurement.cit-document-transformation-1155.local/fhir/QuestionnaireResponse/81747",
            "resource": {
              ...
              "basedOn": [
                {
                  "reference": "https://careplan.cit-document-transformation-1155.local/fhir/ProcedureRequest/61735"
                }
              ],
              "questionnaire": {
                "reference": "https://questionnaire.cit-document-transformation-1155.local/fhir/Questionnaire/85179"
              },
              "status": "completed",
              "subject": {
                "reference": "https://patient.cit-document-transformation-1155.local/fhir/Patient/43964"
              },
              "context": {
                "reference": "https://careplan.cit-document-transformation-1155.local/fhir/EpisodeOfCare/29482"
              },
              "authored": "2021-10-14T06:06:57+00:00",
              "source": {
                "reference": "https://patient.cit-document-transformation-1155.local/fhir/Patient/37823"
              },
              "item": [
                {
                  "linkId": "e20ba5b7-1e94-4e1c-8ab1-ca9c96b9aaac,1.2.208.176.1.5,Sundhedsdatastyrelsen",
          ...
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1155.local/fhir/Composition/24589",
            "resource": {
              ...
              "extension": [
                {
                  ...
                  "valueReference": {
                    "reference": "https://organization.cit-document-transformation-1155.local/fhir/Organization/39073"
                  }
                }
              ],
              "identifier": {
              ...
              "subject": {
                "reference": "https://patient.cit-document-transformation-1155.local/fhir/Patient/60220"
              },
              "date": "2021-10-14T06:06:57+00:00",
              "author": [
                {
                  "reference": "https://patient.cit-document-transformation-1155.local/fhir/Patient/60220"
                }
              ...
              "confidentiality": "N",
              "custodian": {
                "reference": "https://organization.cit-document-transformation-1155.local/fhir/Organization/83203"
              },
              "relatesTo": [
                {
                  "code": "appends",
                  "targetReference": {
                    "reference": "https://document-transformation.cit-document-transformation-1155.local/fhir/Composition/31167"
                  }
                }
              ],
              "section": [
                {
                  "entry": [
                    ...
                    {
                      "reference": "https://measurement.cit-document-transformation-1155.local/fhir/QuestionnaireResponse/81747"
                    },
                    {
                      "reference": "https://document-transformation.cit-document-transformation-1155.local/fhir/DocumentReference/68831"
                    },
                    {
                      "reference": "https://document-transformation.cit-document-transformation-1155.local/fhir/Composition/31167"
                    }
          ...
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1155.local/fhir/Composition/31167",
            "resource": {
              "resourceType": "Composition",
              "id": "31167",
              "meta": {
              ...
              "contained": [
                {
                  ...
                  "managingOrganization": {
                    "reference": "https://organization.cit-document-transformation-1155.local/fhir/Organization/94843"
                  }
                },
                {
                  ...
                  "name": [
                    {
                      "family": "f82b8eeb-d3f9-415d-be0f-cc7876c2ddbd"
                    }
                  ]
                }
              ],
              ...
              "title": "063c7ede-3049-411f-bf86-909036697c5c"
            }
          },
          {
            "fullUrl": "https://document-transformation.cit-document-transformation-1155.local/fhir/DocumentReference/68831",
            "resource": {
              ...
              "indexed": "2021-10-14T06:06:57.267+00:00",
              "content": [
                {
                  "attachment": {
                    "url": "http://some.com/"
          ...
          {
            "fullUrl": "https://patient.cit-document-transformation-1155.local/fhir/Patient/60220",
            "resource": {
              "resourceType": "Patient",
              "id": "60220",
              "meta": {
              ...
              "managingOrganization": {
                "reference": "https://organization.cit-document-transformation-1155.local/fhir/Organization/24310"
              }
            }
          },
          {
            "fullUrl": "https://organization.cit-document-transformation-1155.local/fhir/Organization/83203",
            "resource": {
              ...
              "identifier": [
                {
                  ...
                  "value": "11111111",
                  "period": {
                    "start": "2021-10-14T06:06:57+00:00"
                  }
                },
                {
          ...
          {
            "fullUrl": "https://organization.cit-document-transformation-1155.local/fhir/Organization/39073",
            "resource": {
              "resourceType": "Organization",
              "id": "39073",
              "meta": {
