...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2019-05-13T09:28:16.358+00:00",
    "profile": [
  ...
  "definition": [
    {
      "reference": "http://local.ehealth.sundhed.dk:31380/hapi-fhir-server/fhir/ActivityDefinition/204"
    }
  ],
  "status": "completed",
  "intent": "option",
  "code": {
    "text": "ebb75c2a-dbee-455b-874b-b889e1f2f206"
  },
  "subject": {
    "reference": "http://local.ehealth.sundhed.dk:31380/trifork-fhir-server/Patient/19528"
  },
  "context": {
    "reference": "http://local.ehealth.sundhed.dk:31380/hapi-fhir-server/fhir/EpisodeOfCare/205"
  }
}
```
...
```json
{
  ...
  "meta": {
    "versionId": "2",
    "lastUpdated": "2019-05-13T09:28:16.577+00:00",
    "profile": [
      "http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-procedurerequest"
    ]
  },
