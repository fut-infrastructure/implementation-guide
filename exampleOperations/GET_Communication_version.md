`GET [base]/Communication/847/_history/2`
...
```json
{
  ...
  "meta": {
    "versionId": "2",
    "lastUpdated": "2019-12-16T11:15:19.766+00:00",
    "profile": [
  ...
  "subject": {
    "reference": "https://patient.local.ehealth.sundhed.dk/fhir/Patient/92910"
  },
  "topic": [
    {
      "reference": "https://measurement.local.ehealth.sundhed.dk/fhir/Observation/846"
    }
  ],
  "context": {
    "reference": "https://careplan.local.ehealth.sundhed.dk/fhir/EpisodeOfCare/87419"
  }
}
```