...
```json
{
  ...
  "meta": {
    "versionId": "1",
    "lastUpdated": "2019-05-13T09:27:46.728+00:00",
    "profile": [
  ...
  "contained": [
    {
      ...
      "subject": {
        "reference": "http://local.ehealth.sundhed.dk:31380/trifork-fhir-server/Patient/97157"
      }
    }
  ],
  "definition": [
    {
      "reference": "http://local.ehealth.sundhed.dk:31380/questionnaire/fhir/Questionnaire/66385"
    }
  ],
  "status": "completed",
  "intent": "option",
  ...
  "subject": {
    "reference": "http://local.ehealth.sundhed.dk:31380/trifork-fhir-server/Patient/71358"
  },
  "context": {
    "reference": "http://local.ehealth.sundhed.dk:31380/hapi-fhir-server/fhir/EpisodeOfCare/35"
  },
  "period": {
...
```json
{
  ...
  "meta": {
    "versionId": "2",
    "lastUpdated": "2019-05-13T09:27:47.070+00:00",
    "profile": [
      "http://ehealth.sundhed.dk/fhir/StructureDefinition/ehealth-careplan"
    ]
  },
