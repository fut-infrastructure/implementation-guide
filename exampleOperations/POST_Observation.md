  ...
  "parameter": [
    {
      ...
      "resource": {
        ...
        "basedOn": [
          {
            "reference": "http://local.ehealth.sundhed.dk:31380/hapi-fhir-server/fhir/ProcedureRequest/38868"
          }
        ],
        "status": "amended",
        "code": {
        ...
        "subject": {
          "reference": "http://local.ehealth.sundhed.dk:31380/trifork-fhir-server/Patient/12194"
        },
        "context": {
          "reference": "http://local.ehealth.sundhed.dk:31380/hapi-fhir-server/fhir/EpisodeOfCare/46161"
        },
        "effectivePeriod": {
          "start": "2019-05-13T11:12:59+02:00",
          "end": "2019-05-13T11:12:59+02:00"
        },
        "performer": [
          {
            "reference": "http://local.ehealth.sundhed.dk:31380/trifork-fhir-server/Patient/10731"
          }
        ],
        "device": {
          "reference": "http://local.ehealth.sundhed.dk:31380/hapi-fhir-server/fhir/Device/47842"
        }
      }
    }
  ]
