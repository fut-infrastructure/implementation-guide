  ...
  "parameter": [
    {
      ...
      "resource": {
        ...
        "entry": [
          {
            "fullUrl": "https://document-transformation.local.ehealth.sundhed.dk/fhir/Composition/8740",
            "resource": {
              ...
              "extension": [
                {
                  ...
                  "valueReference": {
                    "reference": "https://organization.local.ehealth.sundhed.dk/fhir/Organization/91745"
                  }
                }
              ],
              "identifier": {
              ...
              "subject": {
                "reference": "https://patient.local.ehealth.sundhed.dk/fhir/Patient/26141"
              },
              "date": "2020-04-30T06:59:10+02:00",
              "author": [
                {
                  "reference": "https://patient.local.ehealth.sundhed.dk/fhir/Patient/26141"
                }
              ...
              "confidentiality": "N",
              "custodian": {
                "reference": "https://organization.local.ehealth.sundhed.dk/fhir/Organization/66914"
              },
              "section": [
                {
                  "entry": [
                    {
                      "reference": "https://device.local.ehealth.sundhed.dk/fhir/Device/30878"
                    },
                    {
                      "reference": "https://measurement.local.ehealth.sundhed.dk/fhir/Observation/16909"
                    }
                  ]
                }
              ]
          ...
          {
            "fullUrl": "https://patient.local.ehealth.sundhed.dk/fhir/Patient/26141",
            "resource": {
              ...
              "managingOrganization": {
                "reference": "https://organization.local.ehealth.sundhed.dk/fhir/Organization/53970"
              }
            }
          },
          {
            "fullUrl": "https://organization.local.ehealth.sundhed.dk/fhir/Organization/66914",
            "resource": {
          ...
          {
            "fullUrl": "https://organization.local.ehealth.sundhed.dk/fhir/Organization/91745",
            "resource": {
              "resourceType": "Organization",
              "id": "91745",
              "meta": {
          ...
          {
            "fullUrl": "https://device.local.ehealth.sundhed.dk/fhir/Device/30878",
            "resource": {
              "resourceType": "Device",
              "id": "30878",
              "meta": {
          ...
          {
            "fullUrl": "https://measurement.local.ehealth.sundhed.dk/fhir/Observation/16909",
            "resource": {
              ...
              "identifier": [
                {
                  ...
                  "value": "729f696d-7ad2-4d84-8fbc-c82119d09c44"
                }
              ],
              "basedOn": [
                {
                  "reference": "https://careplan.local.ehealth.sundhed.dk/fhir/ProcedureRequest/53232"
                }
              ],
              "status": "final",
              "code": {
              ...
              "subject": {
                "reference": "https://patient.local.ehealth.sundhed.dk/fhir/Patient/59453"
              },
              "context": {
                "reference": "https://careplan.local.ehealth.sundhed.dk/fhir/EpisodeOfCare/13757"
              },
              "effectivePeriod": {
                "start": "2020-04-30T06:59:10+02:00",
                "end": "2020-04-30T06:59:10+02:00"
              },
              "performer": [
                {
                  "reference": "https://patient.local.ehealth.sundhed.dk/fhir/Patient/59453"
