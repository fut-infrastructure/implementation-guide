  ...
  "parameter": [
    {
      ...
      "resource": {
        ...
        "entry": [
          {
            "fullUrl": "https://document-transformation.local.ehealth.sundhed.dk/fhir/Composition/88926",
            "resource": {
              ...
              "extension": [
                {
                  ...
                  "valueReference": {
                    "reference": "https://organization.local.ehealth.sundhed.dk/fhir/Organization/88630"
                  }
                }
              ],
              "identifier": {
              ...
              "subject": {
                "reference": "https://patient.local.ehealth.sundhed.dk/fhir/Patient/20284"
              },
              "date": "2020-03-26T11:51:15+01:00",
              "author": [
                {
                  "reference": "https://patient.local.ehealth.sundhed.dk/fhir/Patient/20284"
                }
              ...
              "confidentiality": "N",
              "custodian": {
                "reference": "https://organization.local.ehealth.sundhed.dk/fhir/Organization/27484"
              }
            }
          },
          {
            "fullUrl": "https://patient.local.ehealth.sundhed.dk/fhir/Patient/20284",
            "resource": {
              ...
              "managingOrganization": {
                "reference": "https://organization.local.ehealth.sundhed.dk/fhir/Organization/14877"
              }
            }
          },
          {
            "fullUrl": "https://organization.local.ehealth.sundhed.dk/fhir/Organization/27484",
            "resource": {
          ...
          {
            "fullUrl": "https://organization.local.ehealth.sundhed.dk/fhir/Organization/88630",
            "resource": {
              "resourceType": "Organization",
              "id": "88630",
              "meta": {
          ...
          {
            "fullUrl": "https://questionnaire.local.ehealth.sundhed.dk/fhir/Questionnaire/96041",
            "resource": {
                  ...
                  "extension": [
                    {
                      "url": "reference",
                      "valueReference": {
                        "reference": "https://organization.local.ehealth.sundhed.dk/fhir/Organization/60029"
                      }
                    },
                    {
                      "url": "role",
